  ...
  return (
    <div className="fixed right-4 top-1/2 z-40 -translate-y-1/2 hidden flex-col gap-2 md:flex">
      {socialLinks.map((social) => (
        <Button key={social.label} variant="ghost" size="icon" asChild className="rounded-full backdrop-blur-md bg-orange-500/70 hover:bg-orange-500/40 shadow-2xl text-background transition-transform duration-300 ease-in-out hover:scale-110 shadow-black/50">
