  ...
  return (
    <>
      ...
      <div className="fixed top-4 right-4 z-50 hidden md:flex">
        <div className={cn("flex items-center justify-center bg-accent/90 backdrop-blur-xl rounded-full shadow-2xl transition-all duration-1000 ease-in-out", !navVisible && "w-11 h-11", navVisible && "p-2")}>
          <nav
            className={cn(
              "flex items-center gap-4 transition-all duration-1000 ease-in-out overflow-hidden",
