  ...
  return (
    <>
      ...
      <div className="fixed top-4 right-4 z-50 hidden md:flex">
        <div className={cn("flex items-center justify-center bg-accent/80 backdrop-blur-lg rounded-full shadow-[0_25px_50px_-12px_rgba(0,0,0,0.4)] transition-all duration-1000 ease-in-out", !navVisible && "w-11 h-11", navVisible && "p-2")}>
          <nav
            className={cn(
      ...
      <div className="fixed top-4 right-4 z-50 md:hidden">
        <div className="flex items-center gap-2">
            {socialLinks.map((social) => (
                <Button key={social.label} variant="ghost" size="icon" asChild className="rounded-full bg-accent/80 backdrop-blur-lg shadow-[0_25px_50px_-12px_rgba(0,0,0,0.4)] text-background w-10 h-10 transition-transform duration-300 ease-in-out hover:scale-110 hover:bg-accent/80">
            ...
            <Sheet>
                ...
                <Button variant="ghost" size="icon" className="bg-accent/80 backdrop-blur-lg rounded-full w-10 h-10 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.4)] text-background hover:bg-background/20 transition-transform duration-300 ease-in-out hover:scale-110">
