        ...
        <div className="container mx-auto max-w-7xl px-4 md:px-6">
          <div className="rounded-lg border bg-white text-card-foreground shadow-lg overflow-hidden">
            <div className="grid md:grid-cols-2 items-center">
                <div className="p-6 md:p-4 order-2 md:order-1">
                ...
                <div className="relative aspect-video pointer-events-none order-1 md:order-2 md:p-4">
                    <iframe
                        className="absolute inset-0 w-full h-full md:inset-4 md:w-[calc(100%-2*1rem)] md:h-[calc(100%-2*1rem)]"
