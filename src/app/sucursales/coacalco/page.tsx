...
const sucursal = {
  ...
  phone: "55 2345 6789",
  prices: [
    { title: "Salto Individual", price: "$180/hr", description: "Acceso a todas las áreas de trampolines.", image: "/assets/g1.jpg" },
    { title: "Paquete Amigos", price: "$650/hr (4 personas)", description: "Diversión en grupo con un precio especial.", image: "/assets/g2.jpg" },
    { title: "Pase Anual", price: "$2300", description: "Salta todo el año sin límites.", image: "/assets/g3.jpeg" }
  ],
  ...
  gallery: [
    { src: '/assets/g1.jpg', alt: 'Interior Coacalco' },
