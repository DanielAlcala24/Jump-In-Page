...
const sucursal = {
  ...
  phone: "55 4567 8901",
  prices: [
    { title: "Salto Individual", price: "$220/hr", description: "Acceso a todas las áreas de trampolines.", image: "/assets/g1.jpg" },
    { title: "Paquete Amigos", price: "$800/hr (4 personas)", description: "Diversión en grupo con un precio especial.", image: "/assets/g2.jpg" },
    { title: "Pase Anual", price: "$2800", description: "Salta todo el año sin límites.", image: "/assets/g3.jpeg" }
  ],
  horarios: "Lunes a Viernes: 2 PM - 9 PM | Sábados y Domingos: 11 AM - 9 PM",
  attractions: [
    { name: "Arena Futbol", image: "/assets/g5.jpeg" },
    { name: "Camino al Cielo", image: "/assets/g6.jpeg" },
    ...
    { name: "Laberinto de obstáculos", image: "/assets/g8.jpeg" },
    { name: "Spider Tower", image: "/assets/g8.jpeg" },
    { name: "Kid Zone", image: "/assets_g8.jpeg" },
    { name: "Rope Course Kids", image: "/assets/g6.jpeg" }
  ],
  gallery: [
    { src: '/assets/g1.jpg', alt: 'Interior La Cúspide' },
