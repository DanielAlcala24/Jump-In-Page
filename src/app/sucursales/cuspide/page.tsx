...
const sucursal = {
  name: "La Cúspide",
  address: "Av. Lomas Verdes 1200, Boulevares, 53126 Naucalpan de Juárez, Méx.",
  mapLink: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3761.547844280738!2d-99.25590968509265!3d19.4754719868603!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d203b5f5f5f5f5%3A0x1b1b1b1b1b1b1b1b!2sJump-in%20La%20C%C3%BAspide!5e0!3m2!1ses!2smx!4v1624387970123!5m2!1ses!2smx",
  whatsapp: "525545678901",
  phone: "55 4567 8901",
  prices: [
    { title: "Salto Individual", price: "$220/hr", description: "Acceso a todas las áreas de trampolines.", image: "https://picsum.photos/seed/price1/300/200" },
    { title: "Paquete Amigos", price: "$800/hr (4 personas)", description: "Diversión en grupo con un precio especial.", image: "https://picsum.photos/seed/price2/300/200" },
    { title: "Pase Anual", price: "$2800", description: "Salta todo el año sin límites.", image: "https://picsum.photos/seed/price3/300/200" }
  ],
  ...
  gallery: [
    ...
    { src: 'https://picsum.photos/seed/gal2-cuspide/600/400', alt: 'Gente saltando' },
    { src: 'https://picsum.photos/seed/gal3-cuspide/600/400', alt: 'Fiesta de cumpleaños' },
    { src: 'https://picsum.photos/seed/gal4-cuspide/600/400', alt: 'Exterior de la sucursal' }
  ]
};


export default function SucursalCuspidePage() {
  return (
