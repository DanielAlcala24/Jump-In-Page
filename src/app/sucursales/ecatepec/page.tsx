...
const sucursal = {
  ...
  phone: "55 5678 9012",
  prices: [
    { title: "Salto Individual", price: "$170/hr", description: "Acceso a todas las áreas de trampolines.", image: "https://picsum.photos/seed/price1/300/200" },
    { title: "Paquete Amigos", price: "$600/hr (4 personas)", description: "Diversión en grupo con un precio especial.", image: "https://picsum.photos/seed/price2/300/200" },
    { title: "Pase Anual", price: "$2200", description: "Salta todo el año sin límites.", image: "https://picsum.photos/seed/price3/300/200" }
  ],
  ...
  attractions: [
    ...
    { name: "Drope slide", image: "https://picsum.photos/seed/slide/400/300" },
  ...
  gallery: [
    { src: 'https://picsum.photos/seed/gal1-ecatepec/600/400', alt: 'Interior Ecatepec' },
    { src: 'https://picsum.photos/seed/gal2-ecatepec/600/400', alt: 'Gente saltando' },
    { src: 'https://picsum.photos/seed/gal3-ecatepec/600/400', alt: 'Fiesta de cumpleaños' },
    { src: 'https://picsum.photos/seed/gal4-ecatepec/600/400', alt: 'Exterior de la sucursal' }
  ]
};
